...
const AboutPage = () => {
  return (
    <div className='about'>
        ...
        <p>
            CoinGecko Pro API now serves on-chain DEX data (Beta) across 200+ blockchain networks, 1,600+ decentralized exchanges (DEXes), and 9M+ tokens, powered by GeckoTerminal.
        </p>
        <p>
